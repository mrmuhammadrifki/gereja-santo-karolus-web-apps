...
<p>
    <a href="<?= site_url('pengurapan/create') ?>" class="btn btn-primary mb-3 me-3">Tambah Pengurapan</a>
    <a href="<?= site_url('pengurapan/pdf') ?>" target="_blank" class="btn btn-danger mb-3">
