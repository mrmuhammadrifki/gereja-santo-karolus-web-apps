...
<div class="container mt-4">
    ...
    <form action="<?= site_url('imamat/update/'.$imamat['id']) ?>" method="post">
        <?= csrf_field() ?>
        ...
        <div class="mb-3 row">
            <div class="col">
                ...
                <input type="text" name="tempat_tahbisan"
                    ...
                    value="<?= old('tempat_tahbisan', $imamat['tempat_tahbisan']) ?>">
            ...
            <div class="col">
                ...
                <input type="date" name="tgl_tahbisan"
                    ...
                    value="<?= old('tgl_tahbisan', $imamat['tgl_tahbisan']) ?>">
        ...
        <div class="mb-3">
            ...
            <input type="text" name="penahbis"
                ...
                value="<?= old('penahbis', $imamat['penahbis']) ?>">
