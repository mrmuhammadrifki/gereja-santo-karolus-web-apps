...
<div class="container mt-4">
    ...
    <form action="<?= site_url('krisma/update/'.$krisma['id']) ?>" method="post">
        <?= csrf_field() ?>

        <div class="mb-3">
            <label class="form-label">Nama Lengkap</label>
            <input type="text" name="nama" class="form-control <?= isset($errors['nama']) ? 'is-invalid' : '' ?>"
                value="<?= old('nama', $krisma['nama']) ?>">
        ...
        <div class="mb-3 row">
            <div class="col">
                ...
                <input type="text" name="tempat_krisma"
                    ...
                    value="<?= old('tempat_krisma', $krisma['tempat_krisma']) ?>">
            ...
            <div class="col">
                ...
                <input type="date" name="tgl_krisma"
                    ...
                    value="<?= old('tgl_krisma', $krisma['tgl_krisma']) ?>">
        ...
        <div class="mb-3">
            ...
            <input type="text" name="petugas" class="form-control <?= isset($errors['petugas']) ? 'is-invalid' : '' ?>"
                value="<?= old('petugas', $krisma['petugas']) ?>">
        ...
        <div class="mb-3">
            ...
            <input type="text" name="paroki_asal"
                ...
                value="<?= old('paroki_asal', $krisma['paroki_asal']) ?>">
