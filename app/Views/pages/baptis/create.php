...
<div class="container mt-4">
    ...
    <form action="<?= site_url('baptis/store') ?>" method="post">
        <?= csrf_field() ?>
        ...
        <div class="mb-3">
            ...
            <input type="text" name="ortu" id="ortu"
                class="form-control <?= isset($errors['ortu']) ? 'is-invalid' : '' ?>" value="<?= old('ortu') ?>"
        ...
        <div class="mb-3">
            ...
            <input type="text" name="wali" id="wali"
                class="form-control <?= isset($errors['wali']) ? 'is-invalid' : '' ?>" value="<?= old('wali') ?>"
                placeholder="Masukkan nama wali baptis">
        ...
        <div class="mb-3">
            ...
            <input type="date" name="tgl_bpt" id="tgl_bpt"
                class="form-control <?= isset($errors['tgl_bpt']) ? 'is-invalid' : '' ?>" value="<?= old('tgl_bpt') ?>">
        ...
        <div class="mb-3">
            ...
            <input type="text" name="lokasi_bpt" id="lokasi_bpt"
                ...
                value="<?= old('lokasi_bpt') ?>" placeholder="Masukkan lokasi baptis">
        ...
        <div class="mb-3">
            ...
            <input type="text" name="petugas" id="petugas"
                class="form-control <?= isset($errors['petugas']) ? 'is-invalid' : '' ?>" value="<?= old('petugas') ?>"
