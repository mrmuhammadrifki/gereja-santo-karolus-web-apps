<!-- app/Views/pages/lektor/edit.php -->
...
<div class="container mt-4 mb-5">
    ...
    <form action="<?= site_url('lektor/update/' . $lektor['id']) ?>" method="post">
        <?= csrf_field() ?>
        ...
        <div class="mb-3">
            ...
            <input type="text" name="nama" id="nama"
                ...
                value="<?= old('nama', $lektor['nama']) ?>" placeholder="Masukkan nama lektor">
        ...
        <div class="mb-3">
            ...
            <input type="text" name="tempat_lahir" id="tempat_lahir"
                ...
                value="<?= old('tempat_lahir', $lektor['tempat_lahir']) ?>" placeholder="Masukkan tempat lahir">
        ...
        <div class="mb-3">
            ...
            <input type="date" name="tanggal_lahir" id="tanggal_lahir"
                ...
                value="<?= old('tanggal_lahir', $lektor['tanggal_lahir']) ?>">
        ...
        <div class="mb-3">
            ...
            <select name="jenis_kelamin" id="jenis_kelamin"
                ...
                <option value="L" <?= old('jenis_kelamin', $lektor['jenis_kelamin']) === 'L' ? 'selected' : '' ?>>
                    Laki-laki</option>
                <option value="P" <?= old('jenis_kelamin', $lektor['jenis_kelamin']) === 'P' ? 'selected' : '' ?>>
                    Perempuan</option>
            </select>
        ...
        <div class="mb-3">
            ...
            <select name="status" id="status" class="form-select <?= isset($errors['status']) ? 'is-invalid' : '' ?>">
                ...
                <option value="Aktif" <?= old('status', $lektor['status']) === 'Aktif' ? 'selected' : '' ?>>Aktif
                </option>
                <option value="Tidak Aktif" <?= old('status', $lektor['status']) === 'Tidak Aktif' ? 'selected' : '' ?>>
                    Tidak Aktif</option>
            </select>
        ...
        <div class="mb-3">
            ...
            <input type="number" name="tahun_masuk" id="tahun_masuk"
                ...
                value="<?= old('tahun_masuk', $lektor['tahun_masuk']) ?>" placeholder="Contoh: 2023">
