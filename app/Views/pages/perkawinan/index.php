...
<p>
    <a href="<?= site_url('perkawinan/create') ?>" class="btn btn-primary mb-3 me-2">Tambah Perkawinan</a>
    <a href="<?= site_url('perkawinan/pdf') ?>" target="_blank" class="btn btn-danger mb-3">
