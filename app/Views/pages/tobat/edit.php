    ...
    <form action="<?= site_url('tobat/update/'.$tobat['id']) ?>" method="post">
        ...
        <div class="mb-3">
            ...
            <input type="text" name="paroki_asal"
                ...
                value="<?= old('paroki_asal',$tobat['paroki_asal']) ?>">
        </div>
